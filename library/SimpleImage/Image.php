...
class SimpleImage {
	 ...
	 *@params string	$width,$height,$color)
	 * 
	 */
	 function hollow($width, $height, $color){
		$this->create($width, $height, $color);
	 }
	/**
	...
	function text($text, $font_file, $font_size = 12, $color = '#000000', $position = 'center', $x_offset = 0, $y_offset = 0) {
		...
		// Add the text
		 imagefttext($this->image, $font_size, $angle, $x, $y, $color, $font_file, $text);
